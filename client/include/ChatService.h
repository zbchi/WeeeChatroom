...
private:
    std::string getLogPath(std::string &user_id, std::string &friend_id,bool is_group=false);
    void storeChatLog(std::string &user_id, std::string &peer_id, json &js, bool is_group = false);
